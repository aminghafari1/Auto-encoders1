...
tf.compat.v1.disable_eager_execution() ## this is to disable eager execution in tensorflow 2.0
...
#VAE represents a deep convolutional variational autoencoder architecture with mirrored encoder and decoder components."    
    def __init__(self,
        ...
        self._reconstruction_loss_weight=1000
    ...
    def _add_bottleneck(self, x):
        ## Flatten the data and add a bottleneck with Gaussian sampling (a dense layer)
        ...
        ## lambda layer helps us use keras for wrapping functions within our graph
...
if __name__=="__main__":
    autoencoder= VAE(input_shape=[28,28,1], conv_filters=[32,64,64,64], conv_kernels=[3,3,3,3], conv_strides=[1,2,2,1], latent_space_dim=2)
    autoencoder.summary()
